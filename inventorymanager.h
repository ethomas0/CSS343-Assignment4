...
public:
	...
	Movie* retriveMovie(Movie*, const char&);                // retrive movie from BSTtree
	Movie* retreiveMovie(const char&, ifstream&);
	void displayAll();

private:

	void addError(string);                             // add errors from all invalid movie
